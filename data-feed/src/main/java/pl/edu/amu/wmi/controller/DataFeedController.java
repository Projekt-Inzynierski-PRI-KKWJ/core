...
import pl.edu.amu.wmi.validator.ImportDataFeedValidator;
...
public class DataFeedController {
    ...
    public ResponseEntity<Void> createStudents(@RequestHeader("study-year") String studyYear,
        ...
        ImportDataFeedValidator.validateFileExtension(data, List.of(DataFeedFileExtension.CSV));
    ...
    public ResponseEntity<Void> createCriteria(@RequestHeader("study-year") String studyYear, @RequestParam MultipartFile data) throws Exception {
        ImportDataFeedValidator.validateFileExtension(data, List.of(DataFeedFileExtension.JSON));

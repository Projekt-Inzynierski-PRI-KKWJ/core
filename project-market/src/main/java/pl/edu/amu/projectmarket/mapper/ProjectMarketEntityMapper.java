...
public interface ProjectMarketEntityMapper {
    ...
    @Mapping(target = "proposalName", source = "request.proposalName")
    @Mapping(target = "proposalDescription", source = "request.proposalDescription")
    @Mapping(target = "proposalOwnerId", source = "request.proposalOwnerId")
    @Mapping(target = "proposalStudyYear", source = "request.proposalStudyYear")
